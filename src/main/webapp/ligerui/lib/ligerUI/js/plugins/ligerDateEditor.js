...
(function ($)
{
    ...
    $.ligerui.controls.DateEditor.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function ()
        {
            ...
            dateeditorHTML += "        <div class='l-button l-button-save'></div>";
            ...
            g.buttons = {
                ...
                btnSave: $(".l-button-save", g.toolbar)
            };
            ...
            g.buttons.btnSave.html(p.saveMessage);
            //设置时间
            if (p.showTime)
            {
                g.toolbar.time.show();
            ...
            *************/
            ...
            g.buttons.btnSave.click(function ()
            {
            	g.showDate();
        ...
        updateSelectBoxPosition: function ()
        {
            ...
            if (p.absolute)
            {
            			...
            			&& contentHeight > Number(g.dateeditor.height() + 1))
                {
                    ...
                    g.dateeditor.css({ left: g.text.offset().left, top:g.text.offset().top+1 + g.text.outerHeight() /*g.text.offset().top - 1 - g.dateeditor.height()*/ });
                } else
                {
