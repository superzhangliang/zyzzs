    ...
    $.ligerui.controls.Layout.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            if ($("> div[position=left]", g.layout).length > 0)
            {
                ...
                g.left.header = $('<div class="l-layout-header" style="width:100%"><div class="l-layout-header-toggle"></div><div id="lefttitle" class="l-layout-header-inner"></div></div>');
                ...
                g.left.css({height:p.height, overflow:"hidden"});
            }
            //center
            if ($("> div[position=center]", g.layout).length > 0)
            {
                ...
                //g.center.content.height($(g.element).height()-g.center.header.height());
            } 
            //right
            if ($("> div[position=right]", g.layout).length > 0)
            {
                ...
                g.right.header = $('<div class="l-layout-header"><div class="l-layout-header-toggle"></div><div id="righttitle" class="l-layout-header-inner"></div></div>');
                ...
                g.right.css({height:p.height, overflow:"hidden"});
                //g.left.content.height($(g.element.parentNode).height()-g.left.header.height());
            }
            //lock
            ...
            g.left&&g.left.content.height(g.left.height()-g.left.header.height());
            g.right&&g.right.content.height(g.right.height()-g.right.header.height());
        },
        ...
        _bulid: function ()
        {
            ...
            if (g.left)
            {
                g.left.css({ top: g.middleTop,overflow:"hidden" });
            ...
            if (g.right)
            {
                g.right.css({ top: g.middleTop,overflow:"hidden" });
