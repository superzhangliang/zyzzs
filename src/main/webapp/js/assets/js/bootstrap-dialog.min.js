...
function(t, e) {
	...
	return o.BootstrapDialogModal = n, o.NAMESPACE = "bootstrap-dialog", o.TYPE_DEFAULT = "type-default", o.TYPE_INFO = "type-info", o.TYPE_PRIMARY = "type-primary", o.TYPE_SUCCESS = "type-success", o.TYPE_WARNING = "type-warning", o.TYPE_DANGER = "type-danger", o.DEFAULT_TEXTS = {}, o.DEFAULT_TEXTS[o.TYPE_DEFAULT] = "提示信息", o.DEFAULT_TEXTS[o.TYPE_INFO] = "提示信息", o.DEFAULT_TEXTS[o.TYPE_PRIMARY] = "提示信息", o.DEFAULT_TEXTS[o.TYPE_SUCCESS] = "成功", o.DEFAULT_TEXTS[o.TYPE_WARNING] = "提醒", o.DEFAULT_TEXTS[o.TYPE_DANGER] = "警告", o.DEFAULT_TEXTS.OK = "确定", o.DEFAULT_TEXTS.CANCEL = "取消", o.DEFAULT_TEXTS.CONFIRM = "确认信息", o.SIZE_NORMAL = "size-normal", o.SIZE_SMALL = "size-small", o.SIZE_WIDE = "size-wide", o.SIZE_FULL = "size-full", o.SIZE_LARGE = "size-large", o.BUTTON_SIZES = {}, o.BUTTON_SIZES[o.SIZE_NORMAL] = "", o.BUTTON_SIZES[o.SIZE_SMALL] = "", o.BUTTON_SIZES[o.SIZE_WIDE] = "",  o.BUTTON_SIZES[o.SIZE_FULL] = "", o.BUTTON_SIZES[o.SIZE_LARGE] = "btn-lg", o.ICON_SPINNER = "glyphicon glyphicon-asterisk", o.defaultOptions = {
		type: o.TYPE_PRIMARY,
		size: o.SIZE_NORMAL,
		cssClass: "",
		title: null,
		...
		createModalBody: function() {
			return t('<div class="modal-body" style="width:100%;"></div>')
		},
		...
		updateSize: function() {
			if (this.isRealized()) {
				var e = this;
				this.getModal().removeClass(o.SIZE_NORMAL).removeClass(o.SIZE_SMALL).removeClass(o.SIZE_WIDE).removeClass(o.SIZE_FULL).removeClass(o.SIZE_LARGE), this.getModal().addClass(this.getSize()), this.getModalDialog().removeClass("modal-sm"), this.getSize() === o.SIZE_SMALL && this.getModalDialog().addClass("modal-sm"), this.getModalDialog().removeClass("modal-lg"), this.getSize() === o.SIZE_WIDE && this.getModalDialog().addClass("modal-lg"), this.getSize() === o.SIZE_FULL && this.getModalDialog().addClass("modal-full"), t.each(this.options.buttons, function(n, o) {
		...
		handleModalEvents: function() {
			...
			return this.getModal().on("show.bs.modal", {
				...
				var e = t.data.dialog;
				if(e.isModalEvent(t) && "function" == typeof e.options.onshown){
					var conH = e.getModalContent().height(),
						headH = e.getModalHeader().outerHeight(),
						footH = e.getModalFooter().outerHeight();
					e.getModalBody().css({height: conH - headH - footH});
					e.options.onshown(e);
				}
	...
	}, o.frame = function(opt) {
		//自定义iframe弹窗
		opt.message&&delete opt.message;
		if(opt.src){
			opt.message = createDialogIframe(opt.src,opt.frameId||null);
			var onshow = opt.onshow,
					onshown = opt.onshown;
			opt.onshow = function (dialog){
				setDialogBodyAndFrameHeight(dialog);
				if(onshow)onshow();
			}
			opt.onshown = function (dialog) {
				setDialogBodyAndFrameHeight(dialog);
				if(onshown)onshown();
			}
		}
		return new o(opt).open()
	}, o
});

//生成弹窗body内所需iframe
function createDialogIframe(src,id){
	var iframe = document.createElement("iframe");
	iframe.src=src;
	iframe.id = id||"bootstrapDialogIframe";
	iframe.className = "bootstrapDialogIframe";
	iframe.name = "bootstrapDialogIframe";
...
//获取计算高度
function  getFrameHeight(dialog) {
	var height = dialog.options.height;
	var conH = dialog.getModalContent().height(),
		headH = dialog.getModalHeader().outerHeight()||45,
		footH = dialog.getModalFooter().outerHeight()||45;
	var temp = 70;
	if(height){
		var isPercent = height.indexOf("%")>-1?true:false;
		if(isPercent){
			height = parseInt(height);
			isPercent = height/100;
			var winH = (window.innerHeight - temp- headH - footH)* isPercent;
			height = winH + "px";
		}else{
			if(parseInt(height)>=window.innerHeight - temp- headH - footH){
				height = (window.innerHeight - temp- headH - footH)+"px";
			}else{
				height = parseInt(height)+"px";
			}
		}
	}else{
		var winH = (window.innerHeight - temp- headH - footH);
		height = winH + "px";
	}
	return height;
}
//设置弹窗body高度和内部iframe高度
function setDialogBodyAndFrameHeight(dialog){
	var height = getFrameHeight(dialog),
		frame = dialog.getModalBody().find(".bootstrapDialogIframe");
	frame.css({height: height,border:0});
	if(frame[0] && frame[0].contentWindow){
		frame[0].contentWindow.bootstrapDialogIframeHeight = parseInt(height);
	}
	dialog.getModalBody().css({padding:"0",overflow:"hidden",height: height});
}
